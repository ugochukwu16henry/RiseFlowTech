...
ALTER TABLE IF EXISTS "Schools" ADD COLUMN IF NOT EXISTS "OwnerName" text NULL;
ALTER TABLE IF EXISTS "Schools" ADD COLUMN IF NOT EXISTS "SchoolAdminName" text NULL;
