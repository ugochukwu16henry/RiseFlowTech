          ...
          {selectedSchool && (
            <section className="dashboard-panel" style={{ marginBottom: '1rem' }}>
              ...
              <div className="dashboard-grid" style={{ marginTop: '1rem' }}>
                ...
                <article className="dashboard-card"><p className="dashboard-label">Owner / school admin</p><p className="dashboard-value" style={{ fontSize: '1rem' }}>{selectedSchool.ownerName || '—'}</p><p className="dashboard-sub">School admin: {selectedSchool.schoolAdminName || selectedSchool.principalName || '—'}</p></article>
