  ...
  return (
    <PageLayout title="Privacy Policy & Data Processing">
      <div className="legal-page">
        ...
        <p>Data is processed to facilitate <strong>academic record-keeping</strong>, <strong>parent-teacher communication</strong>, <strong>official transcript generation</strong>, billing (per school contract), and notifications related to the Service. We do not use personal data for marketing or profiling unrelated to the Service.</p>

        <h2>4. Security</h2>
        <p>We use <strong>AES-256 encryption for data at rest</strong> and <strong>TLS 1.3 for data in transit</strong>, in line with standard .NET and industry practice. Access to personal data is restricted to authorised personnel and systems necessary to operate the Service.</p>

        <h2>5. Minors’ Privacy</h2>
        <p>We only process student (minor) data with the <strong>explicit consent of the parent or guardian</strong>, obtained through the school’s use of the RiseFlow Parent Welcome Letter and the <strong>Access Code</strong> system. Parents link their account to a child by entering the unique code provided by the school.</p>

        <h2>6. Your Rights (Data Subjects)</h2>
        <p>Parents and data subjects have the right to <strong>access</strong>, <strong>correct</strong>, or <strong>request deletion</strong> of their or their child’s information at any time. Requests should be made through the school administration or by contacting RiseFlow. We will respond in line with NDPA 2023 and local data protection laws.</p>

        <h2>7. Data Retention</h2>
        <p>We retain data for as long as the school uses the Service and for a limited period thereafter as required by law or contract. When a school leaves, they have 30 days to export data before we delete it.</p>

        <h2>8. Cross-Border and African Jurisdictions</h2>
        <p>RiseFlow serves schools in Nigeria, Ghana, Kenya, South Africa, and other African countries. Where local law requires (e.g. NDPA in Nigeria), we ensure appropriate safeguards for cross-border processing and work with schools to meet national registration or DPCO requirements.</p>
