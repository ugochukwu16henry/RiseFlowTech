  ...
  return (
    <PageLayout title="Terms of Service">
      <div className="legal-page">
        ...
        <h2>1. The Service</h2>
        <p>RiseFlow is a cloud-based school management platform (“the Service”) provided and operated by me, the sole owner of RiseFlow. The Service is provided <strong>“as-is”</strong> to support academic record-keeping, parent-teacher communication, billing, and related operations for schools in Nigeria and other African countries.</p>
        ...
        <p>The <strong>school owns the student and staff data</strong>; I only <strong>process</strong> it on behalf of the school as a data processor through RiseFlow. If a school leaves the platform, they have <strong>30 days to export their data</strong> before it is deleted from my systems. I will not use school or student data for marketing or other purposes beyond providing the Service.</p>
        ...
        <p>By using the Service, the school agrees to the data processing terms set out in the <Link to="/privacy">Privacy Policy</Link>, which describe how I process personal data in line with the Nigeria Data Protection Act (NDPA) 2023 and the Nigeria Data Protection Commission (NDPC) requirements. For schools in other African countries, I align with applicable national data protection laws.</p>
